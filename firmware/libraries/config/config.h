...
#define SWALLOWING_BOTTLE_DETECTION_THRESHOLD 20
...
#define RETURNING_BRAITENBERG_PROX_FORWARD_LEFT_RIGHT_FACTOR 0.002f
#define RETURNING_BRAITENBERG_PROX_FORWARD_RIGHT_LEFT_FACTOR 0.002f
...
#define RETURNING_BRAITENBERG_STOPPING_COUNT 8
