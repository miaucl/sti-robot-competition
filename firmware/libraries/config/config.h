...
enum Mode
{
  ...
  m_collect,               //2 Go to the platform and receive bottles
...
#define RETURNING_BRAITENBERG_PROX_FORWARD_LEFT_RIGHT_FACTOR -0.0045f
#define RETURNING_BRAITENBERG_PROX_FORWARD_RIGHT_LEFT_FACTOR -0.0045f
#define RETURNING_BRAITENBERG_PROX_FORWARD_RIGHT_RIGHT_FACTOR 0.0007f
